...
export class auth {
    constructor(params) {
        ...
        this.modal;
        this.m;
        this.navbar = params.navbar ? document.getElementById(params.navbar) : document.getElementById('navbarMain');
        ...
        this.init = function () {
            ...
            if (me.navbar) {
                ...
                newElement.setAttribute("class", "nav-item ms-2 me-1");
                newElement.innerHTML = htmlNavBar;
                me.navbar.appendChild(newElement);
            } else {
                console.error("me.navbar element not found");
            }
            ...
            nameLogin = document.querySelector("#userLogin");
            btnLogin = document.querySelector("#btnLogin");
            console.log(btnLogin); // Ajoutez cette ligne pour vérifier si l'élément est trouvé
            if (btnLogin) {
                btnLogin.addEventListener('click', e => {
                    if (btnLogin.getAttribute('class') == 'btn btn-outline-success') me.modal.show();
                    else {
                        me.mail = "";
                        me.ident = "";
                        me.key = "";
                        ...
                        me.user = false;
                        me.keyGitHub = "";
                        nameLogin.innerHTML = 'Anonymous';
                        btnLogin.setAttribute('class', 'btn btn-outline-success');
                    }
                });
            } else {
                console.error("Element with ID 'btnLogin' not found");
            }
            ...
            if (!me.mail || !me.ident || !me.key || !me.apiOmk) {
                ...
                me.omk.getUser(u => {
                    if (!u) {
                        ...
                        nameLogin.innerHTML = me.user['o:name'];
                        btnLogin.setAttribute('class', 'btn btn-danger').innerHTML = iconOut;
